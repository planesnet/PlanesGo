...
func TestNormalizeTaskType(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			realWork:  "Creando handler y componentes",
			wantType:  "Desarrollo",
			wantClean: "Desarrollo",
		},
		{
		...
		{
			rawTitle:  "Diseño y maquetación de nueva vista",
			realWork:  "Creando wireframes y especificaciones",
			wantType:  "Análisis y diseño",
			wantClean: "Análisis y diseño",
		},
		{
			rawTitle:  "Corrección de bug en formulario y refactor",
			realWork:  "Arreglando validación de campos",
			wantType:  "Desarrollo",
			wantClean: "Desarrollo",
		},
		{
		...
		{
			rawTitle:  "Batería de pruebas unitarias y cobertura",
			realWork:  "Ejecutando tests de integración",
			wantType:  "Pruebas",
			wantClean: "Pruebas",
		},
		{
